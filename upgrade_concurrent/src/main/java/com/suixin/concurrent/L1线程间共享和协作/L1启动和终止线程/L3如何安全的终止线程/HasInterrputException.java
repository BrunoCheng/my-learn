package com.suixin.concurrent.L1线程间共享和协作.L1启动和终止线程.L3如何安全的终止线程;
...
//	at com.suixin.concurrent.L1线程间共享和协作.L1启动和终止线程.L3如何安全的终止线程.HasInterrputException$UseThread.run(HasInterrputException.java:28)
//当前一次循环try-catch结束 HasInterrputEx
