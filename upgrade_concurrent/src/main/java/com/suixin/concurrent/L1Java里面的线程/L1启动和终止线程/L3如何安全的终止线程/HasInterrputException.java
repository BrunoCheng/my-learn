package com.suixin.concurrent.L1Java里面的线程.L1启动和终止线程.L3如何安全的终止线程;
        ...
        public void run() {
            ...
            while (!isInterrupted()) {
                try {
                    ...
                    interrupt();//异常之后中断标志符会复位为false，需要再次中断
                    e.printStackTrace();
                }
...
//	at com.suixin.concurrent.L1Java里面的线程.L1启动和终止线程.L3如何安全的终止线程.HasInterrputException$UseThread.run(HasInterrputException.java:28)
//当前一次循环try-catch结束 HasInterrputEx
